...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Vibrant, personalized adventure, luxury, and cultural travel experiences crafted by Lets Go Tours and Travels." },
      { name: "author", content: "Lets Go Tours and Travels" },
